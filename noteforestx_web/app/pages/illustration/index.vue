...
<template>
  ...
  <div class="p-4">
    <PageHeader title="插画收藏" subtitle="在这里所有收藏的插画项目将会以它们的创建时间进行排序，此处显示的为预览图，如您需要获取原图请点击目标插画进入二级菜单。" />
    <span class="flex-row space-x-3">
      <Button label="在 1532 中搜索" icon="pi pi-search" severity="primary" size="small" />
